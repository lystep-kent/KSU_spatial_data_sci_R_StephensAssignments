...
```{r}
states <- dplyr::filter(datajoin, STATEFP %in% c("16","30","41","53","56"))
...
tmap_mode("view")
tm_shape(states) +
  tm_polygons("under5", popup.vars = c("Number_Under_5: " = "count5", "Population: " = "B01001e1", id = "NAMELSAD"), title = "Proportion of Population Under 5") +
