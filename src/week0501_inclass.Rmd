...
They're VERY similar, but there are some cases where they might not be the same. Think about when/where, and let's have a class dicussion if you're not sure


Let's subset the parks to our study area. Need to project first!
```{r}
...
- Make a map of just those parks (not all parks), overlaid on a county map
